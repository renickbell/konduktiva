...
let {melodyFromChordProgression} = await import('./utilities-music.mjs')
const {
    Chord,
    Interval,
    Note,
...
let {generativeParseString} = await import('./lsystem.mjs')
let {randomRange, roundTo} = await import ('./utilities-general.mjs')
