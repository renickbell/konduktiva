...
//Action function:
function musicSynthesizerCaller (p,b, e) {if ((mask(p, e.maskMaps[e.players[p].maskMap] ,(e.currentBeat()),1)) != true) {console.log('check if musicalEnv', e instanceof MusicalEnvironment);callMusicSynthesizerRhythm(e, b, p);}}
